  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[calc(100vh-80px)] bg-background p-8 font-mono">
      <h1 className="text-heading-1 font-bold text-foreground mb-6">
        {en.contact_page.get_in_touch}
      </h1>
      <p className="text-body-base text-muted-foreground mb-4 text-center">
      ...
      <p className="text-body-base text-muted-foreground mb-8 text-center">
