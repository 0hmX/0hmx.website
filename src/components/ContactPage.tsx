...
const ContactPage: React.FC = () => {
  return (
    <div className="flex flex-col items-center justify-center min-h-[calc(100vh-80px)] bg-gray-50 p-8 font-mono">
      ...
      <p className="text-lg text-gray-700 mb-4 text-center">{en.contact_page.intro_text}</p>
      <p className="text-xl font-semibold text-black mb-6 font-sans">
        <a href={`mailto:${en.contact_page.email_label.split(': ')[1]}`} className="underline">
          {en.contact_page.email_label}
        </a>
      </p>
      <p className="text-lg text-gray-700 mb-8 text-center">{en.contact_page.resume_intro}</p>
      <a
